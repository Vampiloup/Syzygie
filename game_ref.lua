local game_ref = {
			...
			zoom = {                                -- Zoom state
				...
				min = -20,                                  -- Minimal zoom
				max = 30,                                   -- Maximal zoom
				proche = -5,                                -- Equal or more that state for the camera to be NEAR the system.
				show_label = 8,                             -- Equal or more that state to show System label on the world map
				show_orbitals = 1                          -- Equal or more that state to show Orbitals on the World map
			},
